        ...
        >
          {message && (
            <motion.div
              ...
              className={`p-3 sm:p-4 rounded-xl sm:rounded-2xl text-center font-montserrat text-sm sm:text-base border ${
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              ...
              <input
                ...
                type="text"
                required
                className={`w-full px-4 py-3 sm:py-4 border rounded-xl text-black focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 font-montserrat text-sm sm:text-base ${
            ...
            <div>
              ...
              <input
                ...
                type="email"
                required
                className={`w-full px-4 py-3 sm:py-4 border text-black rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-200 font-montserrat text-sm sm:text-base ${
